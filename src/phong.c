...
/*   Updated: 2016/08/12 13:55:53 by lpilotto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rt.h"

static void		add_color(t_phpa *ph, t_obj *obj, double *d, double p)
{
	rgb_add(ph->diffuse,
	ft_max(ph->light->color.r * obj->mat->color.r * obj->mat->k_diffuse
		* d[0] * p, 0),
	ft_max(ph->light->color.g * obj->mat->color.g * obj->mat->k_diffuse
		* d[0] * p, 0),
	ft_max(ph->light->color.b * obj->mat->color.b * obj->mat->k_diffuse
		* d[0] * p, 0));
	rgb_add(ph->specular,
