...
static int	parse_cylinder_4(char **line, int *i, t_obj *obj, t_tobj *tobj)
{
...
static int	parse_cylinder_3(char **line, int *i, t_obj *obj, t_tobj *tobj)
{
...
static int	parse_cylinder_2(char **line, int *i, t_obj *obj, t_tobj *tobj)
{
